// *******************************************************************************************
// NAME OF MODULE       : Ascend-Sample V.1.0 Utils Module [Header File]                     #
// NAME OF FILE         : Utils.h                                                            #
...
public:
    ...
    */
    ...
    static APP_ERROR CopyImageDataToDevice(ImageData& imageDevice, ImageData srcImage, aclrtRunMode mode);
};